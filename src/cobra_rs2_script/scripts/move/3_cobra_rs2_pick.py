...
import actionlib
from geometry_msgs.msg import PoseStamped, Vector3, Quaternion, PoseArray, Pose
...
def create_random_grasps(grasp_pose, num_grasps=1):
    ...
    for grasp_num in range(num_grasps):
        my_pre_grasp_approach = create_gripper_translation(Vector3(0.0, 0.0, -1.0))  # take object along pos x-axis
